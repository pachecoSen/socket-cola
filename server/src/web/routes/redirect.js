...
module.exports = app => {
    ...
    app.get('/get/css/:file', (req, res) => res.download(resolve(path('css'), `./${req.params.file}.min.css`)));
    app.get('/get/ico/:file', (req, res) => res.download(resolve(path('ico'), `./${req.params.file}.png`)));
}